...
>>> # nextLine = page.__set_text_block__( ['Name Here', 'Address line one', 'Address line two', 'Address line Three', 'P0S 7A1'], 4, 1.75, bold=True )
>>> nextLine = page.setAddress( ['Name Here', 'Address line one', 'Address line two', 'Address line Three', 'P0S 7A1'])
>>> msg = 'Statement produced: Friday, August 24 2012'
>>> nextLine = page.setStatementDate(msg)
>>> msg = ['Our records indicate that the following amount(s) is outstanding by more than 15 days.',  
... 'This may block your ability to borrow or to place holds or to renew materials online or via our',
... 'telephone renewal line. Please go to My Account at http://www.epl.ca/myaccount for full account details.']
>>> myBlock = page.__break_lines__( msg )
>>> # print(myBlock)
>>> nextLine = page.__set_text_block__(myBlock, 0.875, (nextLine - 0.18))
>>> special = "\u00e9"
...
>>> nextLine = page.__set_text__('Statement 1 of 2', 0.875, 4.5 )
>>> canvas.save()
